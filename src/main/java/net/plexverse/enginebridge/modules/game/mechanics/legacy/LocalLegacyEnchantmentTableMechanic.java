...
/**
 * Local implementation of LegacyEnchantmentTableMechanic for 1.21.8 compatibility.
 * This is a simplified version that doesn't use Entity.isGhost() which doesn't exist in 1.21.8.
 */
@Slf4j
public class LocalLegacyEnchantmentTableMechanic implements GameMechanic<MineplexGame>, LegacyEnchantmentTableMechanic {
    ...
    public void setup(@NonNull final MineplexGame mineplexGame) {
        ...
        log.debug("LocalLegacyEnchantmentTableMechanic setup for game: {}", mineplexGame.getName());
    }
    
    @Override
    public void teardown() {
        log.debug("LocalLegacyEnchantmentTableMechanic teardown");
    }
